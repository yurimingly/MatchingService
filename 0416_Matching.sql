...
select * from student;
insert into student(name,password,s_email,s_phone,s_tag) values("이유림","zlehddks0","dldbfladl@naver.com","01098956674","test");
...
insert into board (title,content,writer,email,password,reg_datetime) values("첫번재제목","1내용","이유림","dldbfladl@naver.com","zlehddks0", now());
insert into board (title,content,writer,email,password,reg_datetime) values("두번째제목","2내용","둘쓴이","dldbfladl2@naver.com","zlehddks0", now());
insert into board (title,content,writer,email,reg_datetime) values("3번재제목","3내용","셋쓴이","dldbfladl3@naver.com",now());
select * from board;
...
select * from board where code=3 and password is null;

select s_email from student;
select * from board where password="";
